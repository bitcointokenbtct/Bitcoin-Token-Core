...
In order to support loading of multiple wallets in btct-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is btct.cpp.
...
Changes to btct.cpp
----------------------
btct.cpp is the entry point into btct-qt, and as such, will require some minor modifications to provide hooks for
