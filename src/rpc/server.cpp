...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTCT features */
        {"btct", "masternode", &masternode, true, true, false},
        {"btct", "listmasternodes", &listmasternodes, true, true, false},
        {"btct", "getmasternodecount", &getmasternodecount, true, true, false},
        {"btct", "masternodeconnect", &masternodeconnect, true, true, false},
        {"btct", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"btct", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"btct", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"btct", "masternodecurrent", &masternodecurrent, true, true, false},
        {"btct", "masternodedebug", &masternodedebug, true, true, false},
        {"btct", "startmasternode", &startmasternode, true, true, false},
        {"btct", "createmasternodekey", &createmasternodekey, true, true, false},
        {"btct", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"btct", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"btct", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"btct", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"btct", "getmasternodescores", &getmasternodescores, true, true, false},
        {"btct", "mnsync", &mnsync, true, true, false},
        {"btct", "spork", &spork, true, true, false},
        {"btct", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> btct-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42123/\n";
}
