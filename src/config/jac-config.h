/* src/config/btct-config.h.  Generated from btct-config.h.in by configure.  */
/* src/config/btct-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "btct.org"
