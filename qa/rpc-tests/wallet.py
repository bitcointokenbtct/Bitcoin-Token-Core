...
#   c) node1 mines 32 blocks, so now node 0 has 60001btct, node 1 has 4250btct, node2 has none.
#   d) node0 sends 601 btct to node2, in two transactions (301 btct, then 300 btct).
