Contributing to Bitcoin Token Core
============================

The Bitcoin Token Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitcoin Token Core project, and is not to be
confused with overall BTCT Network Protocol consensus changes.

Whether a pull request is merged into Bitcoin Token Core rests with the project merge
...
Patches that change BTCT consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTCT consensus, it must have been
...
The project leader is the release manager for each Bitcoin Token Core release.
