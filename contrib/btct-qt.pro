...
RESOURCES += src/qt/btct.qrc src/qt/btct_locale.qrc

TRANSLATIONS += src/qt/locale/btct_bg.ts \
                src/qt/locale/btct_de.ts \
                src/qt/locale/btct_en.ts \
                src/qt/locale/btct_es.ts \
                src/qt/locale/btct_fi.ts \
                src/qt/locale/btct_fr.ts \
                src/qt/locale/btct_it.ts \
                src/qt/locale/btct_ja.ts \
                src/qt/locale/btct_pl.ts \
                src/qt/locale/btct_pt.ts \
                src/qt/locale/btct_ru.ts \
                src/qt/locale/btct_sk.ts \
                src/qt/locale/btct_sv.ts \
                src/qt/locale/btct_vi.ts \
                src/qt/locale/btct_zh_CN.ts \
                src/qt/locale/btct_zh_TW.ts
